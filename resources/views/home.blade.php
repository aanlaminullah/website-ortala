            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 lg:py-48">
                <div class="max-w-2xl">
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        @if (setting_bool('modul_publikasi_data') || setting_bool('modul_data_tangkap') || setting_bool('modul_publikasi_dokumen'))
                        <div class="relative group">
                            ...
                            <div
                                ...
                                <div class="absolute -top-1.5 left-6 w-3 h-3 bg-white border-l border-t border-gray-100 rotate-45"></div>
                                <div class="p-2">
