<nav class="sticky top-0 z-50 glass-header transition-all duration-300">
            ...
            <div class="hidden lg:flex items-center space-x-8 text-sm font-medium text-gray-600">
                ...
                @if (setting_bool('modul_berita'))
                    <a href="{{ route('berita.index') }}"
                        class="{{ Request::is('berita*') ? 'text-fish-blue font-semibold' : 'hover:text-fish-blue' }} transition">
                        Berita
                    </a>
                @endif
    ...
    <div id="mobileMenu" class="hidden lg:hidden border-t border-gray-100 bg-white">
        <div class="max-w-7xl mx-auto px-4 py-3 space-y-1">
            ...
            @if (setting_bool('modul_berita'))
                <a href="{{ route('berita.index') }}"
                    class="flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium {{ Request::is('berita*') ? 'text-fish-blue bg-blue-50 font-semibold' : 'text-gray-600 hover:text-fish-blue hover:bg-gray-50' }} transition">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
